...
public class xmlGenera {
  ...
  /****************************************************************************
   * método que  abre la base de datos XML, y si no existe la crea
   * y la abre
  ...
  /******************************************************************************
   * método que crea las colecciones en la base de datos bd y
   * llena cada colección con documentos y/o colecciones según filtro
   * @param bd: bd XML
